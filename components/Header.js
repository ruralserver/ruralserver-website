                  ...
                  <div className="container">
                      <div className="row">
                          <div className="col-2 col-md-2">
                              <a href="/">
                                  <Image width="140px" height="47px" className="svg logo-menu d-block" src="/img/logos/logo.svg" alt="logo Ruralserver" />
                                      <Image width="140px" height="47px" className="svg logo-menu d-none" src="/img/logos/logo-dark.svg" alt="logo Ruralserver" />
                              </a>
                          </div>
